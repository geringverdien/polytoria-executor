...
target("wowiezz")
    ...
    set_languages("c++23")
    add_includedirs(".")
    add_files("**.cpp|injector/*.cpp|hwidspoofer/proxy.cpp|hwidspoofer/hwidspoofer.cpp")
...
target("version")
    set_kind("shared")
    set_languages("c++23")
    add_files("hwidspoofer/proxy.cpp", "hwidspoofer/hwidspoofer.cpp", "unity/unity.cpp", "core/core.cpp")
    add_includedirs(".")
